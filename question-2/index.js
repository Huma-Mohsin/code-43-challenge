...
//Solution
var productOfAllParameters = function () {
    ...
    return parameters.reduce(function (product, num) { return product * num; }, 1); //It uses the reduce() method on the parameters array.
